...
## NixOS Still, MangoWC Now

Gone are the days of XMonad and XMobar. Since realizing I could try Wayland, and really my computer is pretty simply used but a few of my 20+ year experience on Linux pain points were due to Xorg, I gave Hyprland a try and have found the quality of life for normal desktop use to be worth the hassle of switching window managers. That being said, I have switched to MangoWC as being a dynamic tiling window manager it works a lot more like what I am used to coming from Xmonad. 
...
This has probably been a long time coming but I thought I'd actually try this out after so many years of hearing about it but not actually knowing about it. 
