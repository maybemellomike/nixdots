...
Gone are the days of XMonad and XMobar. Since realizing I could try Wayland, and really my computer is pretty simply used but a few of my 20+ year experience on Linux pain points were due to Xorg, I gave Hyprland a try and have found the quality of life for normal desktop use to be worth the hassle of switching window managers. That being said, I have since moved to MangoWC as it is a dynamically tiled window manager with similar bells and whistles as far as getting things to look noice but has more configuration options and seems to be a bit faster and lighter at least in the way I've got it setup compared to Hyprland. 
